...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="mt-2 mb-3">
                <span>
                    Perkiraan cuaca bulan <span class="font-weight-bold" style="color: #013C5E"> {{$thisMonth}}</span>
                </span>
            </div>
            <div class="row pb-5">
                @foreach ($query as $item)
                <div class="col-md-2 mt-2">
                    <a href="{{ route('getDay', ['id'=>$item['date_num']]) }}">
                        ...
                        <div class=" selectCard">
                            ...
                            <div class=""
                                ...
                                <div class=""
                                    ...
                                    @endif
                                    <div class="row">
                                        <div class="col ml-3" style="font-size: 14px">
                                            <i class="fa-solid fa-droplet"></i>
                                            <br>
                                            {{
                                            $item['rain_forecast'] != 0 ? $item['rain_forecast'] : '40'
                                            }} mm
                                        </div>
                                        <div class="col">
                                            <div class="d-flex" style="font-size: 14px">
                                                <div class="ml-auto mt-3 mr-2">
                                                    ...
                                                    <br>
                                                    {{
                                                    $item['temperature'] != 0 ? $item['temperature'] : '-40'
                                                    }} ºC
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col ml-3 mb-2">
                                            <i class="fa fa-cloud fa-3x pr-2"></i>
                                        </div>
                ...
                <div class="col-md-4">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" id="wind_speed">{{
                                        $data[0]['wind_speed'] ?? 0}}
                                        m/s</div>
                                </div>
                                <div class="col-auto">
                ...
                <div class="col-md-4">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" id="wind_chill">{{
                                        $data[0]['wind_chill'] ?? 0 }}
                                    </div>
                                </div>
                                <div class="col-auto">
                ...
                <div class="col-md-4">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="h5 mb-0 font-weight-bold text-gray-800" id="rain_fall">
                                        <?php
                        // $curahHujan = $data[0]['rain_fall'] ?? 0;
                    ?>
                                        mm
                                    </div>
                                </div>
